...
if(writer()){
    ...
    if(isset($_POST["code"])){
        require_once(dirname(dirname(__DIR__))."/config/db_config.php");
            ...
            $insert_sql = "INSERT INTO `posts_db`(`id`, `show`, `timeofc`, `by_name`, `title`, `main_img`, `text`, `main_text`) VALUES (NULL,'$show','".$time."','".$creator_name."','".$name."','".url."blog/upload/".basename($_FILES["image"]["name"])."','".$_POST["code"]."','".$_POST["main_text"]."')";
