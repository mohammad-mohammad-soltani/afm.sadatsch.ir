    ...
    if($result->num_rows > 0){
        ...
        <div class="row">
            ...
            if(admin()){
                ?>
                <div class="col-12">
                <a href="<?php echo url."posts/add" ?>" class="btn btn-primary "><em class="icon ni ni-plus-medi-fill"></em> <span> </span>افزودن مقاله </a>
        ...
        <div class="alert alert-fill alert-light alert-icon">
                                                            <em class="icon ni ni-alert-circle"></em> مقاله ای وجود ندارد ):
        </div>
        <?php
    }
