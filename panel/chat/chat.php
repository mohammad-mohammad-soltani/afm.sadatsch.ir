...
if(get_score($_SESSION["username"]) > level_2){
    ...
    <div class="nk-chat">
                                ...
                                <div class="nk-chat-body show-chat">
                                    ...
                                    while($row = $m_result->fetch_assoc()){
                                        ...
                                        ?>
                                        <div class="chat is-show is-<?php echo $role ?>"><div class="chat-content"><div class="chat-bubble"><div class="chat-msg" dir="auto"><?php echo htmlentities($row["text"]  ) ?></div></div></div></div>
