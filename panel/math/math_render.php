...
curl_close($ch);
    ...
    if (isset($json['result'])) {
            ...
            $answer = $json['result'];
        echo "پاسخ ارائه شده توسط هوش مصنوعی  ".$ai.":";
        echo $answer;
        $sql->query("UPDATE `users_db` SET  `last_answer` = '".$answer."' WHERE `username` =  '".$username."'");
        exit;
...
$sql->close();
    ...
    $added = $r;
    $url = $ai_link."?key=".hajiAPI."&q=" . urlencode($text.$added);
